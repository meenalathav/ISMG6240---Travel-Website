                ...
                <div class="col-sm-4 userTextArea">
                    <article>
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <asp:RequiredFieldValidator ID="rfvReview" CssClass="text-danger text-uppercase" runat="server" ErrorMessage="Please enter a review of your Magic Carpet vacation." ControlToValidate="txtCustReview" Display="Static"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <asp:RequiredFieldValidator ID="rfvName" CssClass="text-danger text-uppercase" runat="server" ErrorMessage="Please enter your name." ControlToValidate="txtCustName" Display="Static"></asp:RequiredFieldValidator>
